...
def build_preference_interpretation_prompt(
    ...
    *,
    ...
    return (
        ...
        "count or operator means strict at_least 1. This application-owned "
        "default applies equally in stored_preference and "
        "current_plan_preference modes. Preserve every explicit count and "
        "operator from the user rather than replacing it with this default. "
        "Do not apply that default to negative or exclusion wording such as "
        "'no', 'avoid', 'without', or 'exclude'.\n"
        "Phrases such as 'if convenient', 'if possible', or 'when practical' "
        "mean best_effort. Do not invent a count or operator unless applying "
        "the application-owned default above, and do not invent a food, "
        "scope, weekday, or strength.\n"
        ...
        "food, scope, or interpretation that the user did not give. "
